...
namespace InventoryManagementApp.Migrations
{
    ...
    [Migration("20231222085040_addtotalSoldtoSale")]
    partial class addtotalSoldtoSale
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("InventoryManagementApp.Models.Sale", b =>
                {
                    ...
                    b.HasOne("InventoryManagementApp.Models.TotalSold", "TotalSold")
                        .WithMany("Sales")
                        .HasForeignKey("TotalSoldId");
